...
public class MyConstant {
    ...
    public static final String AGENT = "/gp/library/gui/agent/agent.fxml";
    public static final String LIST_AGENT = "/gp/library/gui/agent/list/list_agent.fxml";
    public static final String UPDATE_AGENT = "/gp/library/gui/agent/update/update_agent.fxml";
    public static final String SETTING = "/gp/library/gui/settings/settings.fxml";
